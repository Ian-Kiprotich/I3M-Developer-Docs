use i3m::core::variable::InheritableVariable;
use i3m::gui::inspector::editors::collection::VecCollectionPropertyEditorDefinition;
use i3m::gui::inspector::editors::enumeration::EnumPropertyEditorDefinition;
use i3m::gui::inspector::editors::inherit::InheritablePropertyEditorDefinition;
use i3m::{
